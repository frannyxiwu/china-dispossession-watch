...
我丈夫曾经在部队里从云南到北京服役六年，我们家门上都挂着江苏省颁发的退伍军人的牌子。我们村的大队书记本来是张伟明（音译）、现在是华建良（音译），他们因为拆迁的事故意针对我家，我丈夫当六年兵的任何待遇都没有得到，甚至连社保和医保都没有，就是"正革命"打成"反革命" [1]。我丈夫的档案里都是我们大队书记华建良和会计许冬生（音译）做虚假材料。我们不认可、申请复议，江苏省的退役军人事务厅抄送给无锡市退役军人事务局，无锡市又抄送给新吴区退役军人事务局，一直在踢皮球。
...
export const yuChunmeiData = {
    ...
    name: "Yu Chunmei",
    chName: '虞春梅',
    address: "No. 32-33 Chen Alley, Chunming North Village, Fangqian, Jiangxi Street, Xinwu District, Wuxi, Jiangsu, China",
    chineseAddress: "江苏省无锡市新吴区江溪街道坊前春明北村陈巷32-33号",
  ...
  description: [
    ...
    footnotes: [
      { id: "1", en: "The terms ‘revolutionary‘ and ’counter-revolutionary‘ were official political labels during the Mao era. Being labeled a ’revolutionary’ meant enjoying full rights and respect, while a ‘counter-revolutionary’ classification could lead to persecution, loss of employment and social standing. Though these classifications are no longer officially used, they retain powerful emotional and cultural significance, particularly for people who lived through that period.",
                 ch: "’正革命‘和’反革命‘是毛泽东时代的官方政治标签。被标为‘正革命‘意味着享有充分的权利和尊重，而被归类为‘反革命’则可能导致遭受迫害、失业和社会地位丧失。尽管这些分类现已不再官方使用，但它们对经历过那个时代的人们而言仍具有强烈的情感共鸣和文化意义。",},
      { id: "2", en: "Cancellation of a person's household registration ( 户 口 ) effectively erases their legal existence in China's administrative system. Without valid household registration, individuals cannot access healthcare, banking, employment, housing, or other basic services and rights.",
                 ch: "取消一个人的户口实际上抹去了他在中国行政系统中的法律存在。没有有效的户口登记，个人将无法获得医疗、财务、就业、住房或其他基本服务和权利。",},
      { id: "3", en: "Beijing Representative Offices (驻京办) serve as official liaisons between provincial governments and central authorities, handling administrative coordination and economic projects. Established in the 1980s, they also monitor and manage petitioners from their home provinces who travel to Beijing with grievances. Beyond their formal administrative duties, they often coordinate the return of petitioners to their localities through a process commonly referred to as ‘local recovery.’",
                 ch: "驻京办是省级政府与中央当局之间的官方联络点，负责行政协调和经济项目。成立于1980 年代，它们还负责监管来自本省前往北京申诉的上访者。除了正式的行政职责外， 它们通常通过一种被称为‘地方接返’的程序协调上访者返回原籍。",},
    ],
