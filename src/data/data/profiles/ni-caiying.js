...
Each day of that period stretched into an eternity. Unable to move my head, I could only stare at the ceiling of the hospital room. I couldn’t hold back tears the feelings were indescribable. My body ravaged by illness, I fought death daily alone as my only daughter was still in Beijing. In those darkest moments, I made a solemn vow: once I could sit up, I would get to Beijing even if I had to crawl. By 2014, though still desperately weak, through sheer determination and willpower, I gradually learned to sit and eventually traveled to Beijing in a wheelchair. Exhausting every ounce of strength, I finally collapsed at Jiujing Zhuang — the gathering place for disabled petitioners, while the able-bodied went to Majialou [4]. The overcrowded conditions and my raging fever caused me to collapse. I was hospitalized at Beijing's Nanyang Hospital for six months. During October's National Day military parade, authorities  [5] all petitioners, forcibly returning me home. As soon as my strength minimally returned, I resumed petitioning. Nineteen years have now passed. I remain homeless, my case classified as a prominent administrative law violation.
...
2006年6月28号，他们在没有提前通知的情况下故意给我的房子停电停水，停了十多天。夏天天气很热，没有水的话完全没法生存，逼着我自己出去挑水，挑一桶回去要吃几天。7月9日晚饭后我手里提着一个桶，打算出门问前面公房的邻居讨要一些水。迎面开来了一辆集装箱一样又高又大的自卸卡车，司机看到我以后，就把车开到我的家门前。当时我虽然害怕，但还是比较镇静，也怕他撞我，心里想不要万一出了车祸被说“是你走路不小心”，所以我手里拎着桶、站在原地不动。自卸车一会往前、一会往后开了一两分钟，倒来倒去地吓唬我。然后他看到了一根高压电线杆，突然间就倒车撞了上去。电线杆被撞断倒塌，电线也断了、眼看着就掉在地上。电线掉下来的一瞬间瞬间我心里很害怕，感觉到了强烈的危险和危机感，感觉会触电死了。懂电的人都知道，高压电线碰落在地面产生一个十万伏的电压差，碰到地会产生一个大约20米的 [1]。如果碰到人的话人不动还可以、如果动一动马上就会死，变成焦炭一样。当时我站的位置在同心圆靠外的地方，电光火石之间我脑子里想着肯定要跑，但我迈了一脚后立刻飞出去了，飞得很远跌出了同心圆，如果光靠跑肯定是没有那么远。也是老天帮忙，让我免于被电死的命运。
...
我当时是度日如年，头动不了只能朝着病房的天花板，流的眼泪止不住，心里的味道是真的无法形容。我身体被病痛侵袭、不断和死神作斗争，我唯一的女儿还在北京，每天都被妻离子散的荒凉无助感折磨。我那个时候就发了一个誓言，等我可以坐起来，我肯定爬都要爬到北京去。到了2014年，我虽然身体还是很差、一点力气都没有，但是全凭自己的毅力和决心慢慢地学着坐起来，坐着轮椅去北京。我拼尽全力，最后倒在了久敬庄。我们所有的访民，残疾的都去久敬庄，身体健康的都去马家楼 [4]。久敬庄里面人实在太拥挤，我又发着高烧，就这样倒下去，被送去北京的南阳医院住了半年。半年后北京十一国庆节阅兵，就把访民全部清场 [5]，我就被清回家了。等我身体又恢复一点，我还是坚持上访，就这样一直到现在有十九年了，我还是无家可归，我的情况已经属于行政违法积案突出问题。
...
export const niCaiyingData = {
  ...
  description: [
    ...
    footnotes: [
      { id: "1", en: "High-voltage lines (typically 10kV-35kV in Chinese urban distribution networks) create a dangerous step potential in the soil, forming concentric zones of decreasing voltage. Moving between these voltage gradients can be fatal as electricity flows through the body.",
        ch: "高压线（在中国城市配电网中通常为 10 千伏至 35 千伏）在土壤中产生危险的跨步电压，形成电压递减的同心区域。在这些电压梯度之间移动可能致命，因为电流会流经人体。",},
      { id: "2", en: "Euphemism for informal detention used in China since the early 2000s to process petitioners outside formal legal channels. These extralegal mechanisms allow local governments to prevent petitions from reaching higher authorities while maintaining a facade of legality.",
                 ch: "自2000年代以来中国在正规法律渠道之外处理上访者的非正式拘留的委婉说法。这些法外机制允许地方政府阻止上访申诉到达更高层级，同时维持合法性的表象",},
      { id: "3", en: "Historical saying (山高皇帝远) dating to imperial China, describing how local officials exercise autonomy from central authority in distant regions. In contemporary usage, references local government corruption and selective enforcement of central policies.",
                 ch: "‘山高皇帝远’源于帝制中国的历史谚语，描述地方官员如何在远离中央的地区行使自主权。在当代指地方政府腐败和对中央政策的选择性执行。",},
      { id: "4", en: "Jiujingzhuang (久敬庄) and Majialou (马家楼) are two prominent facilities in Beijing historically used to detain petitioners. Officially termed 'relief service centers,' these establishments have functioned as extralegal detention centers. Petitioners intercepted in Beijing are often confined in these facilities before being forcibly returned to their hometowns. conditions in these centers have been described as overcrowded, lacking due process, with numerous allegations of abuse.",
                 ch: "久敬庄与马家楼是北京两处长期用于关押上访者的主要设施，官方称为“救济服务中心”。它们充当着法外拘禁场所，被截访的人员常在此被临时关押，随后被强制遣返回原籍。这些场所的条件被形容为过度拥挤、缺乏正当程序，且屡有虐待指控。",},
      { id: "5", en: "In the lead-up to politically sensitive dates, authorities conduct extensive “stability maintenance” operations. These include the systematic removal of petitioners from Beijing through detention and forced repatriation. Such actions are coordinated by Beijing’s local enforcers as well as liaison offices from the petitioners’ hometowns to avoid visible social unrest and to project a harmonious and stable national image.",
                 ch: "在临近政治敏感日期时，当局开展大规模“维稳”行动，包括通过拘留和强制遣返的方式系统性地清除北京的上访人员。这些行动由北京市的地方执法人员以及上访者原籍地的驻京办共同协调执行，旨在避免社会不稳定现象的曝光，并营造和谐稳定的国家形象。",},
    ],
